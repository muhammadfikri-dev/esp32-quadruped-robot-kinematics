/**
 * =========================================================================================
 * Project     : ESP32 Quadruped Robot Trot Gait & IMU Stabilization Engine
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : 12-DOF quadruped robot dog implementing inverse kinematics, dynamic trot/crawl gaits, active IMU body compliance leveling, and Wi-Fi teleoperation.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-quadruped-robot-kinematics";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Quadruped Robot Trot Gait & IMU Stabilization Engine"));
